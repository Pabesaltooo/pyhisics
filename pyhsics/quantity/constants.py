...
class Constants:
    ...
    unidades en el SI.
    """
    e0: ScalarQuantity = ScalarQuantity(
    ...
    mu0: ScalarQuantity = ScalarQuantity(
        4 * pi * 1e-7,
        'N/A^2 = N/A**2'
    )
    """
    ...
    c: ScalarQuantity = ScalarQuantity(
        float('299792458'),
        'm/s = m/s'
    )
    """
    ...
    PI: ScalarQuantity = ScalarQuantity(pi, '1')
    """
    Número Pi.
    """
    
    E: ScalarQuantity = ScalarQuantity(e, '1')
    """
    Número e.
    """
    
    e_: ScalarQuantity = ScalarQuantity(float('1.60217662e-19'), 'C')
    """
    Carga elemental (e) en coulomb.
    """
    
    me_: ScalarQuantity = ScalarQuantity(float('9.10938356e-31'), 'kg')
    """
    Masa del electrón (mₑ) en kg.
    """
    
    mp_: ScalarQuantity = ScalarQuantity(float('1.6726219e-27'), 'kg')
    """
    Masa del protón (mₚ) en kg.
    """
    
    mn_: ScalarQuantity = ScalarQuantity(
    ...
    G: ScalarQuantity = ScalarQuantity(
        float('6.67430e-11'),
    ...
    h: ScalarQuantity = ScalarQuantity(
    ...
    Na: ScalarQuantity = ScalarQuantity(
        float('6.02214076e23'),
        '1/mol = 1/mol'
    )
    """
    ...
    kB: ScalarQuantity = ScalarQuantity(
        float('1.380649e-23'),
        'J/K=J/K'
    )
    """
    ...
    R: ScalarQuantity = ScalarQuantity(
        float('8.314462618'),
        'J/(mol*K)= J/(mol*K)'
    )
    """
    ...
    sigma: ScalarQuantity = ScalarQuantity(
    ...
    alpha: ScalarQuantity = ScalarQuantity(
    ...
    phi0: ScalarQuantity = ScalarQuantity(
